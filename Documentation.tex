...
\item \out{ʇ} can be produced using \key|G-p t|
\item \out{ʖ} can be produced using \key|G-p s|
\item \out{ʗ} can be produced using \key|G-p S-c|
\item \out{ʞ} can be produced using \key|G-p k|
\end{itemize}
